  ...
  return (
    <Dialog open={open} onOpenChange={(v) => !v && onClose()}>
      <DialogContent className="max-w-2xl p-0 overflow-hidden border-none bg-background shadow-lux flex flex-col max-h-[95vh] rounded-2xl md:max-h-[90vh]">
        ...
        <DialogHeader className="p-6 md:p-8 bg-gradient-to-br from-orange-500/5 via-primary/5 to-background border-b border-border/40 shrink-0">
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <span className="text-[10px] uppercase tracking-wider text-orange-600 font-bold">Secure Gate</span>
                  ...
                  <div key={s.key} className="flex items-center">
                    <span 
                      className={cn(
                        ...
                        i < activeIdx ? "bg-orange-600 text-white" :
                        i === activeIdx ? "bg-orange-600 text-white shadow-sm font-extrabold ring-4 ring-orange-600/15" :
                    ...
                    {i < 4 && (
                      <span className={cn("h-[2px] w-4 transition-all duration-300", i < activeIdx ? "bg-orange-600" : "bg-muted")} />
                    )}
                  </div>
                ))}
              </div>
            ...
            {step !== "confirm" && (
              <div className="md:hidden flex items-center justify-between text-xs border border-border bg-accent/40 rounded-xl p-2.5">
                ...
                <span className="font-bold text-orange-600 bg-orange-500/5 px-2 py-0.5 rounded-lg border border-orange-500/10">Step {activeIdx + 1} of 5</span>
              </div>
            )}
          </div>
        </DialogHeader>
        ...
        <DialogBody className="p-6 md:p-8 overflow-y-auto space-y-6 max-h-[60vh]">
          ...
          {step === "summary" && (
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="p-4 bg-orange-500/5 border border-orange-500/10 rounded-xl">
                <p className="text-xs md:text-sm text-orange-800 dark:text-orange-300 leading-relaxed">
              ...
              <div className="rounded-2xl border border-border bg-card overflow-hidden shadow-sm">
                <div className="p-5 flex gap-4 border-b border-border bg-accent/10">
                  ...
                  <div>
                    <span className="text-[9px] uppercase tracking-wider bg-orange-600/10 text-orange-600 px-2 py-0.5 rounded-md font-bold">{property.property_category || "Fractional Real Estate"}</span>
                ...
                <div className="p-5 grid grid-cols-2 gap-y-4 gap-x-6 bg-card text-sm">
                  ...
                  <div>
                    ...
                    <span className="font-bold text-orange-600 text-base mt-0.5 block">{property.projected_return_min}% - {property.projected_return_max}% p.a.</span>
                  </div>
                  <div>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              <label 
                className={cn(
                  ...
                  ackChecked ? "border-orange-600 bg-orange-500/5 shadow-sm" : "border-border"
                )}
              >
                <Checkbox 
                  id="modal-terms-ack" 
                  ...
                  className="mt-1 border-muted-foreground/40 data-[state=checked]:bg-orange-600 data-[state=checked]:border-orange-600" 
                />
                <div>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              ...
              {method === "third_party_provider" && (
                <div className="space-y-4 animate-in fade-in duration-300">
                  <div className="p-4 bg-orange-500/5 border border-orange-500/10 rounded-xl">
                    <h5 className="font-bold text-xs text-orange-800 dark:text-orange-300 flex items-center gap-1.5">
                      <Wallet className="h-4 w-4" />
                      Buy Digital Currency Assistance Flow
                    </h5>
                    <p className="text-[11px] text-orange-800/80 leading-relaxed mt-1">
                  ...
                  <div className="grid gap-3 sm:grid-cols-2">
                    <div className="border border-border rounded-xl p-4 bg-card hover:border-orange-600/50 hover:shadow-sm transition-all flex flex-col justify-between">
                      <div>
                        <div className="flex justify-between items-start">
                          <span className="font-bold text-sm text-foreground">MoonPay</span>
                          <span className="text-[9px] bg-orange-600/10 text-orange-600 px-1.5 py-0.5 rounded font-bold">Recommended</span>
                        </div>
                  ...
                  <div className="rounded-xl border border-border bg-accent/10 p-5 space-y-3">
                    ...
                    <div className="relative pl-5 border-l border-border/80 space-y-4 text-xs text-muted-foreground">
                      <div className="relative">
                        <span className="absolute -left-[27px] top-[2px] h-3.5 w-3.5 rounded-full bg-orange-600 border border-background flex items-center justify-center text-[8px] text-white font-bold">1</span>
                      ...
                      <div className="relative">
                        <span className="absolute -left-[27px] top-[2px] h-3.5 w-3.5 rounded-full bg-orange-600 border border-background flex items-center justify-center text-[8px] text-white font-bold">2</span>
                      ...
                      <div className="relative">
                        <span className="absolute -left-[27px] top-[2px] h-3.5 w-3.5 rounded-full bg-orange-600 border border-background flex items-center justify-center text-[8px] text-white font-bold">3</span>
                      ...
                      <div className="relative">
                        <span className="absolute -left-[27px] top-[2px] h-3.5 w-3.5 rounded-full bg-orange-600 border border-background flex items-center justify-center text-[8px] text-white font-bold">4</span>
                  ...
                  <div className="rounded-2xl border border-border bg-card overflow-hidden shadow-sm">
                    ...
                    <div className="p-6 flex flex-col items-center border-b border-border bg-card">
                      ...
                      <button 
                        ...
                        className="group relative bg-white p-4 rounded-2xl border border-border shadow-sm hover:shadow-md hover:border-orange-600/30 transition-all focus:outline-none"
                      >
                    ...
                    <div className="p-5 bg-card space-y-4">
                      ...
                      <div className="border border-border/80 bg-accent/15 rounded-xl p-3.5 flex justify-between items-center">
                        ...
                        <Button 
                          variant="outline" 
                          size="sm" 
                          className="h-10 px-4 rounded-lg flex items-center gap-1 font-semibold text-xs transition-all hover:bg-orange-600/5 hover:border-orange-600/40"
                          onClick={() => handleCopyText(String(paymentData?.cryptoAmount), "crypto_amount")}
                        >
                          {copyStates["crypto_amount"] ? (
                            <><Check className="h-4 w-4 text-orange-600" /> Copied</>
                          ) : (
                      ...
                      <div className="border border-border/80 bg-accent/15 rounded-xl p-3.5 flex justify-between items-center gap-4">
                        ...
                        <Button 
                          variant="outline" 
                          size="sm" 
                          className="h-10 px-4 rounded-lg flex items-center gap-1 font-semibold text-xs shrink-0 transition-all hover:bg-orange-600/5 hover:border-orange-600/40"
                  ...
                  <div className="p-5 space-y-4">
                    ...
                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-center border-b border-border pb-3 text-xs">
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        >
                          {copyStates["bank_acc"] ? <Check className="h-4 w-4 text-orange-600" /> : <Copy className="h-3.5 w-3.5 text-muted-foreground" />}
                        </Button>
                      </div>
                    </div>
                    ...
                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-center border-b border-border pb-3 text-xs">
                      ...
                      <div className="flex items-center justify-end gap-2">
                        ...
                        >
                          {copyStates["bank_routing"] ? <Check className="h-4 w-4 text-orange-600" /> : <Copy className="h-3.5 w-3.5 text-muted-foreground" />}
                        </Button>
                      </div>
                    </div>

                    <div className="grid grid-cols-[1fr_2fr] gap-4 items-center pt-1 text-xs">
                      <span className="font-semibold text-orange-600 uppercase tracking-wider text-[10px]">Payment Reference</span>
                      <div className="flex items-center justify-end gap-2">
                        <span className="font-mono font-extrabold text-orange-600 bg-orange-500/5 border border-orange-500/10 px-2 py-0.5 rounded-md">{paymentData?.reference}</span>
                        <Button 
                          variant="ghost" 
                          size="icon" 
                          className="h-8 w-8 rounded-lg"
                        ...
                        >
                          {copyStates["bank_ref"] ? <Check className="h-4 w-4 text-orange-600" /> : <Copy className="h-3.5 w-3.5 text-muted-foreground" />}
                        </Button>
                      </div>
                    </div>
                  </div>
              ...
              <div className="rounded-2xl border border-border bg-accent/15 p-5 space-y-4">
                ...
                <div className="space-y-3.5 text-xs text-muted-foreground leading-normal">
                  <div className="flex gap-3.5 items-start">
                    <span className="h-5.5 w-5.5 bg-orange-600/15 text-orange-600 border border-orange-500/20 rounded-full flex items-center justify-center font-bold shrink-0 text-[10px]">1</span>
                  ...
                  <div className="flex gap-3.5 items-start">
                    <span className="h-5.5 w-5.5 bg-orange-600/15 text-orange-600 border border-orange-500/20 rounded-full flex items-center justify-center font-bold shrink-0 text-[10px]">2</span>
                  ...
                  <div className="flex gap-3.5 items-start">
                    <span className="h-5.5 w-5.5 bg-orange-600/15 text-orange-600 border border-orange-500/20 rounded-full flex items-center justify-center font-bold shrink-0 text-[10px]">3</span>
                    <p>Capture screenshot or export PDF receipt once transaction is finalized.</p>
                  </div>
                  <div className="flex gap-3.5 items-start">
                    <span className="h-5.5 w-5.5 bg-orange-600/15 text-orange-600 border border-orange-500/20 rounded-full flex items-center justify-center font-bold shrink-0 text-[10px]">4</span>
            ...
            <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
              <div className="space-y-2">
                ...
                <Input 
                  ...
                  className="h-13 rounded-xl border-border bg-accent/40 focus:bg-background transition-all font-bold text-sm focus-visible:ring-orange-600/40"
                />
              ...
              <div className="space-y-2">
                ...
                {proofUrl ? (
                  <div className="relative rounded-2xl border border-orange-600/30 overflow-hidden group shadow-sm bg-accent/20">
                    ...
                    <div className="absolute inset-0 bg-background/80 flex items-center justify-center opacity-0 group-hover:opacity-100 transition-opacity">
                      <Button variant="outline" className="rounded-xl font-semibold border-orange-600/30 hover:bg-orange-600/5 text-xs h-10" onClick={() => fileInputRef.current?.click()}>
                  ...
                  <div 
                    ...
                    className={cn(
                      ...
                      isDragOver ? "border-orange-600 bg-orange-500/5 scale-[1.01]" : "border-border hover:border-orange-600/40 hover:bg-accent/40",
          ...
          {step === "confirm" && (
            <div className="py-8 flex flex-col items-center text-center space-y-6 animate-in fade-in zoom-in duration-500">
              <div className="h-20 w-20 rounded-full bg-orange-600/10 flex items-center justify-center animate-bounce [animation-duration:1500ms]">
                <CheckCircle2 className="h-10 w-10 text-orange-600" />
              </div>
              
              <div className="space-y-2 max-w-sm mx-auto">
                <span className="text-[10px] uppercase tracking-wider text-orange-600 bg-orange-500/5 border border-orange-500/10 px-2 py-0.5 rounded font-extrabold">
              ...
              <div className="rounded-2xl border border-border bg-accent/10 p-5 max-w-md text-xs text-left space-y-3.5">
                ...
                <div className="flex gap-3">
                  <Building2 className="h-4.5 w-4.5 text-orange-600 shrink-0 mt-0.5" />
        ...
        <DialogFooter className="p-6 md:p-8 bg-accent/20 border-t border-border/40 shrink-0 flex flex-row items-center gap-3">
          {step === "summary" && (
            <Button className="w-full h-13 text-sm font-semibold rounded-xl bg-orange-600 hover:bg-orange-700 text-white" onClick={() => setStep("acknowledgement")}>
          ...
          {step === "acknowledgement" && (
            <div className="flex gap-2.5 w-full">
              ...
              <Button className="flex-1 h-13 text-sm font-semibold rounded-xl bg-orange-600 hover:bg-orange-700 text-white" disabled={!ackChecked} onClick={() => setStep("method")}>
          ...
          {step === "method" && (
            <div className="flex gap-2.5 w-full">
              ...
              <Button className="flex-1 h-13 text-sm font-semibold rounded-xl bg-orange-600 hover:bg-orange-700 text-white" disabled={loading} onClick={handleCreateInvestment}>
          ...
          {step === "instructions" && (
            <div className="flex gap-2.5 w-full">
              ...
              <Button className="flex-1 h-13 text-sm font-semibold rounded-xl bg-orange-600 hover:bg-orange-700 text-white" onClick={() => setStep("proof")}>
          ...
          {step === "proof" && (
            <div className="flex gap-2.5 w-full">
              ...
              <Button className="flex-1 h-13 text-sm font-semibold rounded-xl bg-orange-600 hover:bg-orange-700 text-white" disabled={loading || !hash || !proofUrl} onClick={handleSubmitProof}>
                {loading ? <Loader2 className="h-4.5 w-4.5 animate-spin" /> : "Submit Verification proof"}
              </Button>
            </div>
          )}
          {step === "confirm" && (
            <Button className="w-full h-13 text-sm font-semibold rounded-xl bg-orange-600 hover:bg-orange-700 text-white" onClick={() => {
              onClose();
      ...
      <Dialog open={qrZoomed} onOpenChange={setQrZoomed}>
        <DialogContent className="max-w-sm p-8 flex flex-col items-center justify-center text-center gap-4 rounded-2xl border-none">
          ...
          <Button className="w-full h-11 text-xs font-semibold rounded-xl mt-4 bg-orange-600 hover:bg-orange-700 text-white" onClick={() => setQrZoomed(false)}>
            Close Zoomed View
          </Button>
        </DialogContent>
      </Dialog>
