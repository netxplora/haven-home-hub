        ...
        return (
          <div key={s.id} className="group relative rounded-xl border border-border/50 bg-card overflow-hidden shadow-soft transition-all duration-300 hover:shadow-card hover:border-border">
             <div className="relative aspect-[16/10] overflow-hidden">
                <LazyImage src={p.cover_image_url || "/placeholder.svg"} aspectClass="" wrapperClassName="h-full w-full" className="h-full w-full object-cover transition-transform duration-500 group-hover:scale-105" alt={p.title} />
