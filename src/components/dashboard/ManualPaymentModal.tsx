        ...
        <DialogBody className="py-8">
          {step === "method_select" && (
            <div className="space-y-6">
              ...
              {propertyData?.property_type === 'land' && (
                <div className="bg-rose-500/5 rounded-xl p-5 border border-rose-500/20 shadow-sm">
                  <h4 className="text-sm font-semibold mb-2 text-rose-700 flex items-center gap-2">
          ...
          {step === "proof" && paymentData && (
            <div className="space-y-6">
              ...
              {draftSavedText && (
                <p className={`text-xs text-center font-medium ${draftSavedText.includes("failed") ? "text-destructive" : "text-rose-600"}`}>
                  {draftSavedText}
                </p>
              )}
