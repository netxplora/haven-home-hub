                    ...
                    <div className="grid gap-4">
                      {signedDocs.map((doc: any) => (
                        <div key={doc.id} className="flex flex-col sm:flex-row items-center justify-between p-5 rounded-xl border border-border bg-card gap-4">
                          ...
                          <Badge variant="outline" className="bg-rose-500/10 text-rose-600 border-rose-500/20 shrink-0">
                        ...
                        <div className="flex items-center gap-2 mt-2">
                          <Badge 
                            ...
                            className={cn(
                              ...
                              doc.status === 'available' ? "bg-rose-500/10 text-rose-600" :
            ...
            {isLoadingCertificates ? (
              ...
              <div className="grid gap-4 md:grid-cols-2">
                {certificates.map((cert: any) => (
                  <div key={cert.id} className="p-5 rounded-xl border border-rose-500/20 bg-rose-500/5 hover:border-rose-500/40 transition-colors flex flex-col h-full justify-between">
                    <div>
                      <div className="flex items-center justify-between mb-3">
                        <div className="h-10 w-10 rounded-full bg-rose-500/10 flex items-center justify-center">
                          <ShieldCheck className="h-5 w-5 text-rose-600" />
                        </div>
                        <Badge variant="outline" className="bg-rose-50 text-rose-700 border-rose-200">Verified</Badge>
                      </div>
