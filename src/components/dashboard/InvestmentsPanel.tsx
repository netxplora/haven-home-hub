                          ...
                          <td className="px-6 py-5">
                            <div className="flex items-center gap-3">
                               <div className="h-10 w-10 rounded-xl overflow-hidden bg-muted group-hover:scale-105 transition-transform shrink-0">
                                  <LazyImage src={inv.investment_properties?.cover_image_url || "/placeholder.svg"} aspectClass="" wrapperClassName="h-full w-full" className="h-full w-full object-cover" alt="" />
                               </div>
                               <div>
  ...
  return (
    <div className="group rounded-xl border border-border/40 bg-card overflow-hidden shadow-soft transition-all duration-300 hover:shadow-card hover:border-primary/20 cursor-pointer" onClick={onSelect}>
       <div className="relative aspect-[16/9] overflow-hidden bg-accent">
          <LazyImage src={investment.investment_properties?.cover_image_url || "/placeholder.svg"} aspectClass="" wrapperClassName="h-full w-full" className="h-full w-full object-cover transition-transform duration-700 group-hover:scale-105" alt="" />
