                  ...
                  <div className="p-8 rounded-lg bg-secondary/20 border border-border space-y-6">
                     ...
                     <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-2 leading-relaxed">
                           By submitting these documents, you confirm that all provided information is authentic and represents your legal identity for investment purposes. {brand.platform_name} reserves the right to request additional documentation for AML/KYC compliance.
                        </p>
                     </div>
