            ...
            <div className="rounded-xl border border-border bg-card p-6 shadow-card overflow-hidden">
              <div className="flex items-center gap-4">
                <div className="relative">
                  ...
                  <div className="absolute -bottom-1 -right-1 h-6 w-6 bg-rose-500 rounded-full border-4 border-card flex items-center justify-center">
              ...
              <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3">
                ...
                {agent.whatsapp && (
                  <Button asChild variant="outline" className="rounded-xl h-11 border-rose-500/20 text-rose-600 hover:bg-rose-50 shadow-sm font-bold text-xs">
