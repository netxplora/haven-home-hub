                    ...
                    <tr key={doc.id} className="hover:bg-muted/30 transition-colors">
                      ...
                      <td className="px-5 py-4">
                        <Badge variant="outline" className={
                          doc.status === 'available' || doc.status === 'verified' || doc.status === 'delivered' ? "bg-rose-500/10 text-rose-600 border-rose-500/20 capitalize" : "bg-amber-500/10 text-amber-600 border-amber-500/20 capitalize"
                        }>
