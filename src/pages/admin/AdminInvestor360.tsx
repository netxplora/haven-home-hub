                      ...
                      {(!activityData?.investments?.length && !activityData?.payments?.length) ? (
                        ...
                        .map((item: any, idx) => (
                          <div key={idx} className="flex gap-3 items-start">
                            <div className={`h-8 w-8 rounded-full flex items-center justify-center shrink-0 ${item._type === 'inv' ? 'bg-primary/10 text-primary' : 'bg-emerald-500/10 text-emerald-600'}`}>
