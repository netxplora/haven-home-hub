            ...
            <div key={r.id} className="rounded-xl border border-border bg-card p-4 shadow-sm space-y-4">
              <div className="flex justify-between items-start">
                ...
                <div>
                  ...
                  {r.status === "published" && <Badge variant="outline" className="bg-rose-500/10 text-rose-500 border-rose-500/20"><CheckCircle2 className="w-3 h-3 mr-1"/> Published</Badge>}
