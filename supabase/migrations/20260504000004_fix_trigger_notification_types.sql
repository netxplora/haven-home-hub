-- Fix notification type enum values in the payment status trigger.
-- Previous version used 'payment' which is NOT a valid notification_type enum value.
-- Also adds payment_id to user_investments for traceability,
-- and adds investment_confirmed / booking_confirmed notifications.
