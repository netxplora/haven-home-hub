...
-- US Properties
UPDATE public.properties SET city = 'Denver', state = 'CO', country = 'USA' WHERE address ILIKE '%Denver, CO%';
UPDATE public.properties SET city = 'New York City', state = 'NY', country = 'USA' WHERE address ILIKE '%New York City, NY%';
UPDATE public.properties SET city = 'Los Angeles', state = 'CA', country = 'USA' WHERE address ILIKE '%Los Angeles, CA%';
UPDATE public.properties SET city = 'Houston', state = 'TX', country = 'USA' WHERE address ILIKE '%Houston, TX%';
...
UPDATE public.investment_properties SET city = 'New York City', state = 'NY', country = 'USA' WHERE location = 'New York City, NY';
UPDATE public.investment_properties SET city = 'Los Angeles', state = 'CA', country = 'USA' WHERE location = 'Los Angeles, CA';
UPDATE public.investment_properties SET city = 'Houston', state = 'TX', country = 'USA' WHERE location = 'Houston, TX';
