...
VALUES (
  ...
  '<div class="legal-doc">
    ...
    <div class="doc-body">
      ...
      <p><strong>VENDOR:</strong> Haven Home Hub (the "Seller")</p>
...
VALUES (
  ...
  '<div class="legal-doc">
    ...
    <div class="doc-body">
      ...
      <p><strong>ASSIGNOR:</strong> Haven Home Hub (Represented by authorized signatories)</p>
...
VALUES (
  ...
  '<div class="legal-doc">
    ...
    <div class="doc-body">
      ...
      <p><strong>SELLER:</strong> Haven Home Hub</p>
...
VALUES (
  ...
  '<div class="legal-doc text-center">
    <div class="doc-header my-6">
      <h1 class="text-3xl font-serif text-rose-800">HAVEN HOME HUB</h1>
...
VALUES (
  ...
  '<div class="legal-doc text-center border-4 border-rose-800 p-8 rounded-3xl bg-amber-50/10">
    <div class="doc-header my-4">
      <h1 class="text-3xl font-serif text-rose-800 tracking-wide font-extrabold">HAVEN HOME HUB</h1>
    ...
    <div class="doc-body text-left max-w-xl mx-auto leading-relaxed space-y-4">
      ...
      <p class="text-center font-bold text-lg bg-background p-4 border border-rose-500/20 rounded-xl font-serif text-rose-900">{{property_name}}</p>
